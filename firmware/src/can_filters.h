...
const uint8_t can_filter[] PROGMEM =
{
    ...
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_PUMPS), // Filter 1

    // Group 1
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_STATE), // Filter 0
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_PUMPS), // Filter 0
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_STATE), // Filter 1
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_PUMPS), // Filter 1
